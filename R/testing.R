...
write_new_crop100_t = function(.gridid, .p_gridid, .crop, .p_crop, .simrow, .date, .argsgcm.ssp,
  ...
  if (.model %in% 'public') {
    ...
    crop_100 = crop_100[!V1 %in% '0.0     LUXEUPF(1)',]
    crop_100 = crop_100[!V1 %in% '0.0     LUXEUPF(2)',]
    crop_100 = crop_100[!V1 %in% '0.0     LUXEUPF(3)',]
    crop_100 = crop_100[!V1 %in% '0.0     CSTGEUPF(1)',]
    crop_100 = crop_100[!V1 %in% '0.0     CSTGEUPF(2)',]
    crop_100 = crop_100[!V1 %in% '0.0     CSTGEUPF(3)',]
    crop_100 = crop_100[!V1 %in% '0.0               LUXEUPF(1)',]
    crop_100 = crop_100[!V1 %in% '0.0               LUXEUPF(2)',]
    crop_100 = crop_100[!V1 %in% '0.0               LUXEUPF(3)',]
    crop_100 = crop_100[!V1 %in% '0.0               CSTGEUPF(1)',]
